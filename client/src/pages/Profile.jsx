...
const Profile = () => {
  ...
  // Query for fetch user profile data
  const {
    data: user,
    isLoading,
    refetch,
  ...
  // refectch the user profile data if the username in params changes
  useEffect(() => {
    refetch();
  }, [username]);
            ...
            <>
              ...
              <div className="flex justify-end px-4 mt-5">
                ...
                {!isMyProfile && (
                  <button
                    disabled={isPending}
                    className="btn btn-outline rounded-full btn-sm disabled:opacity-80"
